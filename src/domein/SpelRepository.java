...
public class SpelRepository {
	 ...
	 */
	protected List<String> getSpelNamen() throws RuntimeException{
	 ...
	 */
	protected Spel geefSpel(String spelNaam) throws RuntimeException {
	 ...
	 */
	protected void insertSpel(Spel spel)  throws RuntimeException {
